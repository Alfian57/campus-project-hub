...
export default function NewProjectPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        <div>
          <p>Proyek berhasil dipublikasikan!</p>
          <p className="text-green-400 text-sm">+{ACTION_POINTS.CREATE_PROJECT} EXP</p>
        </div>
      );
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold text-zinc-50">Buat Proyek Baru</h1>
          <p className="text-zinc-400 mt-1">
            Bagikan proyekmu dengan komunitas
          </p>
        </div>
        <div className="bg-green-500/10 px-3 py-1.5 rounded-lg border border-green-500/20">
          <span className="text-green-400 text-sm font-medium">
            +{ACTION_POINTS.CREATE_PROJECT} EXP
          </span>
        </div>
      </div>
